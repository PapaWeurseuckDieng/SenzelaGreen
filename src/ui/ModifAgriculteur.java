...
public class ModifAgriculteur extends javax.swing.JFrame {
    ...
    private void initComboBoxes() {
        role_cbx.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "admin", "agriculteur" }));
    ...
    private void ajouterAgriculteur() {
        try {
            ...
            if (nom_tf.getText().isEmpty() || prenom_tf.getText().isEmpty() || 
                telephone_tf.getText().isEmpty() || email_cbx.getText().isEmpty() || 
                mdp_pf.getPassword().length == 0) {
                JOptionPane.showMessageDialog(this, "Veuillez remplir tous les champs obligatoires");
                return;
            }

            // Vérification du format de téléphone
            if (!telephone_tf.getText().matches("^[0-9]{10}$")) {
                JOptionPane.showMessageDialog(this, "Le numéro de téléphone doit contenir 10 chiffres");
                return;
            }

            // Vérification du format d'email
            if (!email_cbx.getText().matches("^[\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}$")) {
            ...
            Utilisateur agriculteur = new Utilisateur(
                ...
                adresse_tf.getText(),
                (String) role_cbx.getSelectedItem(),
                (String) genre_cbx.getSelectedItem(),
                email_cbx.getText(),
                new String(mdp_pf.getPassword()),
                culture_tf.getText().isEmpty() ? null : culture_tf.getText()
            );

            // Insertion dans la base de données
            if (UtilisateurDao.ajouterAgriculteur(agriculteur)) {
                JOptionPane.showMessageDialog(this, "Agriculteur ajouté avec succès!");
                new AgriculteurTable().setVisible(true);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Erreur lors de l'ajout de l'agriculteur");
            }
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        ...
                                        .addComponent(id_tf, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))))
